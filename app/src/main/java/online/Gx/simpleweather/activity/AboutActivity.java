    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.project_address:
                ...
                intent_project.setData(Uri.parse("https://github.com/"));
                startActivity(intent_project);
                break;
            case R.id.my_blog:
                Intent intent_blog = new Intent(Intent.ACTION_VIEW);
                intent_blog.setData(Uri.parse("https://weibo.com/u/5688865113"));
                startActivity(intent_blog);
                break;
            case R.id.qq_qun:
                Intent intent_qq = new Intent(Intent.ACTION_VIEW);
                intent_qq.setData(Uri.parse("https://jq.qq.com/?_wv=1027&k=5osuDo2"));
