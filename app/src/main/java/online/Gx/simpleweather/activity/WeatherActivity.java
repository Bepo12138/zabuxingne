package online.Gx.simpleweather.activity;
...
import online.Gx.simpleweather.R;
import online.Gx.simpleweather.model.CityList;
import online.Gx.simpleweather.model.CityListAdapter;
import online.Gx.simpleweather.service.AutoUpdateService;
import online.Gx.simpleweather.util.HttpCallbackListener;
import online.Gx.simpleweather.util.HttpUtil;
import online.Gx.simpleweather.util.ScreenShotUtils;
import online.Gx.simpleweather.util.ShareUtils;
import online.Gx.simpleweather.util.ToastUtil;
import online.Gx.simpleweather.util.Utility;
...
public class WeatherActivity extends Activity implements SwipeRefreshLayout.OnRefreshListener, OnClickListener {
    ...
    // 用于显示天气信息对应的图片  ic000iv被用在侧边栏图标切换
    ...
    private void findView() {
        ...
        //将上面定义的方法和参数与侧边栏和主页面的.xml对应，无需new
